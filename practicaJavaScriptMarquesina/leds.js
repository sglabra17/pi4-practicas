...
var LED04 = new Gpio(21, 'out'), //use declare variables for all the GPIO output pins
  LED17 = new Gpio(20, 'out'),
  LED27 = new Gpio(16, 'out'),
  LED22 = new Gpio(12, 'out'),
  LED18 = new Gpio(1, 'out'),
  LED23 = new Gpio(7, 'out'),
  LED24 = new Gpio(8, 'out'),
